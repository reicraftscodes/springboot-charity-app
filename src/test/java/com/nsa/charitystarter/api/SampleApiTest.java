...
public class SampleApiTest {
    ...
    public void checkSampleApiResponseIsHello() throws Exception {
        // performs get
//        mvc.perform(get("/sample"))     // expects HTTP 200
//                .andExpect(status().isOk())// expects home view
//                .andExpect(view().name("sample"))
//                .andExpect(content()
//                        .string(containsString("Welcome to...."))
//                );
        mvc.perform(get("/sample")).andExpect(status().isOk()).andExpect(content().string(containsString("This is a sample response")));
